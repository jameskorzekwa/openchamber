...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.status.waitingSingleDefault': '正在等待背景程序',
  'sessions.sidebar.session.status.waitingMany': '正在等待 {count} 個背景程序',
  ...
  'chat.ptyWaiting.backgroundProcess': '背景程序',
  'chat.ptyWaiting.backgroundProcesses': '{count} 個背景程序',
  'chat.ptyWaiting.ariaSingleDescription': '等待：{description}',
  'chat.ptyWaiting.ariaSingleDefault': '正在等待背景程序',
  'chat.ptyWaiting.ariaMany': '正在等待 {count} 個背景程序',
